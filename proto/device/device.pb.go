...
type GeoHash struct {
	Geohash string `protobuf:"bytes,1,opt,name=geohash" json:"geohash,omitempty"`
}

func (m *GeoHash) Reset()                    { *m = GeoHash{} }
func (m *GeoHash) String() string            { return proto.CompactTextString(m) }
func (*GeoHash) ProtoMessage()               {}
func (*GeoHash) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

func (m *GeoHash) GetGeohash() string {
	if m != nil {
		return m.Geohash
	}
	return ""
...
type ExpoPushTokens struct {
	Token []string `protobuf:"bytes,1,rep,name=token" json:"token,omitempty"`
}

func (m *ExpoPushTokens) Reset()                    { *m = ExpoPushTokens{} }
func (m *ExpoPushTokens) String() string            { return proto.CompactTextString(m) }
func (*ExpoPushTokens) ProtoMessage()               {}
func (*ExpoPushTokens) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }

func (m *ExpoPushTokens) GetToken() []string {
	if m != nil {
		return m.Token
	}
	return nil
...
func (*MobileNumber) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func init() {
	...
	proto.RegisterType((*GeoHash)(nil), "device.GeoHash")
	proto.RegisterType((*ExpoPushTokens)(nil), "device.ExpoPushTokens")
...
type DeviceServiceClient interface {
	...
	GetExpoPushTokensByGeoHash(ctx context.Context, in *GeoHash, opts ...grpc.CallOption) (*ExpoPushTokens, error)
}
...
func (c *deviceServiceClient) GetExpoPushTokensByGeoHash(ctx context.Context, in *GeoHash, opts ...grpc.CallOption) (*ExpoPushTokens, error) {
	out := new(ExpoPushTokens)
	err := grpc.Invoke(ctx, "/device.DeviceService/GetExpoPushTokensByGeoHash", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceServiceServer interface {
	...
	// Get list of tokens based on the GeoHash
	GetExpoPushTokensByGeoHash(context.Context, *GeoHash) (*ExpoPushTokens, error)
}
...
func _DeviceService_GetExpoPushTokensByGeoHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GeoHash)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).GetExpoPushTokensByGeoHash(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/device.DeviceService/GetExpoPushTokensByGeoHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).GetExpoPushTokensByGeoHash(ctx, req.(*GeoHash))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DeviceService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetExpoPushTokensByGeoHash",
			Handler:    _DeviceService_GetExpoPushTokensByGeoHash_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
